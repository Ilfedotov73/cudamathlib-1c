...
#include "impl/test.h"
#include "impl/MatDet.h"
#include "impl/MatMul.h"
...
long CAddInNative::GetNParams(const long lMethodNum)
{
	...
	case MatDet_enum: return 2;
	case MatMul_enum: return 3;
	default:
		return 0;
	}
...
bool CAddInNative::HasRetVal(const long lMethodNum)
{
	...
	case Test:
		return true;
	case MatDet_enum: return true;
	case MatMul_enum: return true;
	default:
		return false;
	}
...
bool CAddInNative::CallAsFunc(const long lMethodNum, tVariant* pvarRetValue, tVariant* paParams, const long lSizeArray)
{
	...
	case MatDet_enum: return MatDet(lMethodNum, pvarRetValue, paParams, lSizeArray, m_iMemory);
	case MatMul_enum: return MatMul(lMethodNum, pvarRetValue, paParams, lSizeArray, m_iMemory);
	default:
		return false;
	}
